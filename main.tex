...
\begin{figure}[htbp]
\centerline{\includegraphics[scale=0.75]{integrate_exe_times.png}}
...
\begin{figure}[htbp]
\centerline{\includegraphics[scale=0.5]{UML_threaded_wasm.png}}
...
\begin{figure}[htbp]
\centerline{\includegraphics[scale=0.5]{WASM_MC_compiler.png}}
